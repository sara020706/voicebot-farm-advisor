...
import VoiceOutput from '@/components/sections/VoiceOutput';
...
export default function Index() {
  ...
  const renderSection = () => {
    switch (section) {
      ...
      case 'voiceInput': return <VoiceInput lang={lang} onParsed={handleVoiceParsed} onNavigate={setSection} />;
      case 'voiceOutput': return <VoiceOutput lang={lang} />;
